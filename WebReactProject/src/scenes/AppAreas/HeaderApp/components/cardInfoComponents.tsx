import { CheckOutlined, SettingOutlined, DesktopOutlined, EllipsisOutlined, ShoppingCartOutlined } from '@ant-design/icons';
...
export default function CardInfoComponents(props: ICardInfoProps) {
    return (
        <>
            <Dropdown
                trigger={['click']}
