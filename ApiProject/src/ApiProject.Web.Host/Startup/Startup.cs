...
namespace ApiProject.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAbpWithoutCreatingServiceProvider<ApiProjectWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("ApiProject.Web.Host.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                if (canShowSummaries)
                {
                    ...
                    var applicationXml = $"ApiProject.Application.xml";
                    var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                    options.IncludeXmlComments(applicationXmlPath);

                    var webCoreXmlFile = $"ApiProject.Web.Core.xml";
